...
echo "... starting evaluation of $DL_DATA_TEST ..."
python3 $DL_SCRIPTS/cnn_test.py $DL_OUT $DL_PARAM_FILE $DL_MDL_PATH $DL_DATA_TEST | \
    tee $DL_OUT/01_decode_train.log | grep "Average"
echo "... finished evaluation of $DL_DATA_TEST ..."
